...
#define DECODER_1A0 24
#define DECODER_1A1 25

#define DEVICE_NAME "MIG4Leds"
#define CLASS_NAME  "MIG4LedsClass"
...
static const int LedGpioPin[2] = {DECODER_1A0, DECODER_1A1};;
